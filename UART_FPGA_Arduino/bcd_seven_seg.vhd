...
begin
    ...
    begin
        if rising_edge(clock_i)then
				...
				disp <= "1110"; -- liga o primeiro display da placa
				
            case bcd_i is
                when "0000" => seven_o <= "1000000"; -- "0"   
                when "0001" => seven_o <= "1111001"; -- "1" 
                when "0010" => seven_o <= "0100100"; -- "2" 
                when "0011" => seven_o <= "0110000"; -- "3" 
                when "0100" => seven_o <= "0011001"; -- "4" 
                when "0101" => seven_o <= "0010010"; -- "5"
                when "0110" => seven_o <= "0000010"; -- "6"  
                when "0111" => seven_o <= "1111000"; -- "7" 
                when "1000" => seven_o <= "0000000"; -- "8"     
                when "1001" => seven_o <= "0010000"; -- "9" 
